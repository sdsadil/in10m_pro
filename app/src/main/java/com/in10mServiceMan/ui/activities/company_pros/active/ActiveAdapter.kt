...
class ActiveAdapter(val mList: List<ActiveData>, val context: Context, val v: ActiveInterface): RecyclerView.Adapter<ActiveAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(p0: ViewHolder, p1: Int) {
        p0.itemview.acButton.text = "DEACTIVATE"
        ...
        p0.itemview.acButton.setOnClickListener {
            ...
            v.deactivate(compId, mList[p1].id)
        }
    }
